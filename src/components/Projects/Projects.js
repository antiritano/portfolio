          ...
          >
            <div className="js-flickity flex justify-center items-center">
              <ButtonBack
                ...
                className="w-6 h-6 md:w-14 md:h-14 rounded-full flex justify-center items-center bg-white border border-gray-300 hover:bg-gray-400 absolute left-0 lg:ml-8 -ml-4 focus:outline-none focus:bg-gray-400 focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 cursor-pointer"
                id="prev"
              >
                <svg
                  width={8}
                  ...
                  <div className={styles.Projects__project}>
                    ...
                    <div className={styles.Projects__projectText}>
                      <h2>
                        ...
                        <br />
                        Migrated the existing GXVE beauty shopify eccomerce site
                        to a new custom built React application utilizing a
                        headless CMS. The new site provided an updated user
                  ...
                  <div className={styles.Projects__project}>
                    ...
                    <div className={styles.Projects__projectText}>
                      <h2>
                        ...
                        Handled all aspects of the project from start to finish
                        including: Game design & development, sound design,
                  ...
                  <div className={styles.Projects__project}>
                    ...
                    <div className={styles.Projects__projectText}>
                      <h2>
                        ...
                        planners and admins to have unique experiences based on
                        their role.
                      </h2>
                      <h2 className={styles.Project__text}>
                        <span className={styles.Green}>Tech Stack: </span>
                  ...
                  <div className={styles.Projects__project}>
                    ...
                    <div className={styles.Projects__projectText}>
                      <h2>
                        ...
                        custom built React application utilizing a headless CMS.
                        The new site provided an updated user experience and
                        design while providing the client with an easier way to
                        upload and edit the content on the site.
                      </h2>
                      <h2 className={styles.Project__text}>
                        <span className={styles.Green}>Tech Stack: </span>
                        <br />
                  ...
                  <div className={styles.Projects__project}>
                    ...
                    <div className={styles.Projects__projectText}>
                      <h2>
                        <span className={styles.Green}>Description: </span>
                        <br />
                        Built a Discord Bot using Javascript to integrate Super
                        Quick Question into the Discord server environment.
                      </h2>
                      <h2 className={styles.Project__text}>
                        <span className={styles.Green}>Tech Stack: </span>
                        <br />
